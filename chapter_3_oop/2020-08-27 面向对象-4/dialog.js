...
export default class Dialog extends EventTarget{
    constructor({width="30%",height="250px", title="测试标题",content="测试内容",dragable=true,maskable=true}){
        super();
        //作业：合并配置，用老师之外的方法合并配置，外部有配置传入以 外部配置为准，如果没有配置传入就调用默认配置；
        // this.opts = opts;
        // let { width="30%",height="250px", title="测试标题",content="测试内容",dragable=true,maskable=true} = opts;
        // 方式一：
        this.opts = {
            width,
            tittle,
